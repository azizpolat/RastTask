...
public class TC08_NameSymbolCharacter {
    ...
    public void kullaniciKartAdAlaninaSembolGirer() {
        ReusableMethods.waitFor(1);
        ReusableMethods.sendKeysJS(cardPageObject.cardNameButton,ConfigReader.getProperty("character_name"));

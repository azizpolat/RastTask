...
public class TC04_WrongLetter {
    ...
    public void kullaniciKartNumarasiAlaninaHarflerGirer() {
        ReusableMethods.waitFor(1);
        cardPageObject.cardNumberButton.click();
        cardPageObject.cardNumberButton.sendKeys(ConfigReader.getProperty("wrong_letter"));

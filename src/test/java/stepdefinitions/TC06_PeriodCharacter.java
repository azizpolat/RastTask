...
public class TC06_PeriodCharacter {
    ...
    public void kullaniciKartNumarasiAlaninaNoktalamaIsaretleriGirer() {
        ReusableMethods.waitFor(1);
        cardPageObject.cardNumberButton.click();
        cardPageObject.cardNumberButton.sendKeys(ConfigReader.getProperty("period_character"));

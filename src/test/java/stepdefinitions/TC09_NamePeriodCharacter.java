...
public class TC09_NamePeriodCharacter {
    ...
    public void kullaniciKartAdAlaninaNoktalamaIsaretiGirer() {
        ReusableMethods.waitFor(1);
        ReusableMethods.sendKeysJS(cardPageObject.cardNameButton,ConfigReader.getProperty("period_name"));
